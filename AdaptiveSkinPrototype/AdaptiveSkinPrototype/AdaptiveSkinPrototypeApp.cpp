// AdaptiveSkinPrototype.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include "rhinoSdkPlugInDeclare.h"
#include "AdaptiveSkinPrototypeApp.h"
...
BEGIN_MESSAGE_MAP(CAdaptiveSkinPrototypeApp, CWinApp)
END_MESSAGE_MAP()

// The one and only CAdaptiveSkinPrototypeApp object
static class CAdaptiveSkinPrototypeApp theApp;

// CAdaptiveSkinPrototypeApp initialization

BOOL CAdaptiveSkinPrototypeApp::InitInstance()
{
...
int CAdaptiveSkinPrototypeApp::ExitInstance()
{
...
/////////////////////////////////////////////////////////////////////////////
// class CAdaptiveSkinPrototypeSkinDLL
//
class CAdaptiveSkinPrototypeSkinDLL : public CRhinoSkinDLL
{
public:
  CAdaptiveSkinPrototypeSkinDLL();
  ~CAdaptiveSkinPrototypeSkinDLL();
...
// The one and only CAdaptiveSkinPrototypeSkinDLL object. 
// This must be created for the skin to load.
static class CAdaptiveSkinPrototypeSkinDLL theSkin;

CAdaptiveSkinPrototypeSkinDLL::CAdaptiveSkinPrototypeSkinDLL()
: m_hIcon(NULL)
{
}
...
const wchar_t* CAdaptiveSkinPrototypeSkinDLL::ApplicationName()
{
  ...
  return L"AdaptiveSkinPrototype";
}

// Return CSkinPlugInSamplePlugIn::PlugInID()
UUID CAdaptiveSkinPrototypeSkinDLL::SkinPlugInID()
{
  ...
  //static const GUID AdaptiveSkinPrototypePlugIn_UUID = ON_nil_uuid;
  //return AdaptiveSkinPrototypePlugIn_UUID;
  return ON_UuidFromString(RhinoPlugInId());
}

void CAdaptiveSkinPrototypeSkinDLL::ShowSplash( bool bShow )
{
...
HICON CAdaptiveSkinPrototypeSkinDLL::MainRhinoIcon()
{
...
HMENU CAdaptiveSkinPrototypeSkinDLL::MainRhinoMenu()
{
